...
import NewsDetailSlider from "../../../News/components/NewsDetailSlider";
import { useState } from "react";
import NewsCardSlider from "../../../News/components/NewsCardSlider";
...
export default function AdminNewsCard({ news, fetchNews }: AdminNewsCardProps) {
